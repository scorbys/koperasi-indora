        ...
        <div class="row">
            ...
            <div class="col-md-12">                
                <div class="box">
                    ...
                    <div class="box-body">
                        <form action="keanggotaan/mitra/aksi_tambah" method="post" enctype="multipart/form-data">                                
                            <div class="form-group">
                                <label for="">Nama Koperasi</label>
                                <input type="text" name="nama" pattern="[A-Za-z 0-9]+" class="form-control" placeholder="Nama Koperasi" required>
                            </div>
                            <div class="form-group">
                                <label for="">Alamat</label>
                                <input type="text" name="alamat" pattern="[A-Za-z 0-9]+" class="form-control" placeholder="Alamat" required>
                            </div>
                            <!--<div class="form-group">
                                <label for="">Titik Koordinat Maps</label>
                                <input type="text" name="maps" class="form-control" placeholder="Titik Koordinat Maps Ex. -6.9626749,111.4221246" required>
                            </div>-->
                            <div class="form-group">
