...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Pengambilan Simpanan Anggota<small> 7INDORA</small>
        </h1>
        <ol class="breadcrumb">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>No. Anggota <code>*)</code></label>
                                         <input type="hidden" name="id_firebase" id="id_firebase" class="form-control" placeholder="No. Anggota" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nama" id="nama" pattern="[A-Za-z 0-9]+" class="form-control" placeholder="Nama Anggota" readonly required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
