...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
        Edit <?= $title ?><small> 7INDORA</small>
        </h1>
        <ol class="breadcrumb">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="no_anggota" pattern="[A-Za-z 0-9]+" class="form-control" placeholder="No. Anggota" value="<?= $a->no_anggota ?>">
                                        <input type="hidden" name="id_user" pattern="[A-Za-z 0-9]+" value="<?= $a->id_user ?>">
                                    </div>
                                    <div class="form-group">
                                        <label>Nama Anggota</label>
                                        <input type="text" name="nama" pattern="[A-Za-z 0-9]+" class="form-control" placeholder="Nama Anggota" value="<?= $a->nama ?>" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="">No. KTP</label>
                                        <input type="text" name="ktp" pattern="[A-Za-z 0-9]+" class="form-control" placeholder="No. KTP" value="<?= $a->ktp ?>">
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="pekerjaan" pattern="[A-Za-z 0-9]+" class="form-control" placeholder="Pekerjaan" value="<?= $a->pekerjaan ?>">
                                    </div>
                                </div>  
                            </div>
                            <div class="row">          
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="no_hp" pattern="[A-Za-z 0-9]+" class="form-control" value="<?= $a->no_hp ?>" placeholder="No. HP">
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        <label for="">RT</label>
                                        <input type="text" name="rt" pattern="[A-Za-z 0-9]+" placeholder="RT" value="<?= $a->rt ?>" class="form-control" >
                                    </div>
                                </div>      
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        <label for="">RW</label>
                                        <input type="text" name="rw" pattern="[A-Za-z 0-9]+" placeholder="RW" value="<?= $a->rw ?>" class="form-control" >
                                    </div>
                                </div>
                            </div>
                            <div class="row">
