        ...
        <nav class="navbar navbar-static-top">
            <div class="container">
                <div class="navbar-header">
                    <a href="keanggotaan/home" class="navbar-brand"><b>INDORA</b></a>
                    ...
                    <ul class="nav navbar-nav">
                        <li class="dropdown <?php if($title == 'Data Anggota & Pengguna'){ echo 'active'; } ?>">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                <li class="divider"></li>
                                <li><a href="keanggotaan/mitra">Data Mitra Indora</a></li>
                                <li class="divider"></li>
                        ...
                        <li class="dropdown <?php if($title == 'Data Laporan'){ echo 'active'; } ?>">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                <li class="divider"></li>
                                <li><a href="keanggotaan/ppob/koperasi">Keuntungan Koperasi</a></li>
                                <!--<li class="divider"></li>
