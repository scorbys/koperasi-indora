          ...
          <div class="row">
            <div class="col-lg-6">
              ...
              <div class="form-group">
                ...
                <input type="text" name="no_anggota" pattern="[A-Za-z 0-9]+" id="no_anggota" class="form-control" placeholder="No. Anggota" required>
                <input type="hidden" name="id_user" id="id_user" class="form-control" placeholder="No. Anggota" required>
              </div>
              <div class="form-group">
                <label for="">Nama Anggota</label>
                <input type="text" name="nama" pattern="[A-Za-z 0-9]+" class="form-control" placeholder="Nama Anggota" readonly>
              </div>
            </div>
            <div class="col-lg-6">
              <!-- <div class="form-group">
            ...
            <div class="col-lg-3">
              <div class="form-group">
                ...
                <input type="text" name="kecamatan" pattern="[A-Za-z 0-9]+" class="form-control" placeholder="Nama Kecamatan" readonly>
              </div>
            </div>
            <div class="col-lg-3">
              <div class="form-group">
                <label for="">Desa</label>
                <input type="text" name="kelurahan" pattern="[A-Za-z 0-9]+" class="form-control" placeholder="Nama Kelurahan" readonly>
              </div>
            </div>
          </div>
        </div>
              ...
              <div class="col-lg-6">
                  ...
                  <div class="form-group">
                      ...
                      <select name="level" class="form-control" required>
                          <option value="1">Admin 7INDORA</option>
