...
<html>
	<head>
        ...
        <!--===============================================================================================-->	
        <link rel="icon" type="image/png" href="img/icon_7indora_app.png"/>
        <!--===============================================================================================-->
	...
	<body class="hold-transition login-pager" style="background: linear-gradient(to top, #0562589e 0%, #0562589e 100%) no-repeat center center fixed;">
		...
		<div class="login-box">
			<div class="login-logo">
				<a href="" class=""><img src="<?php echo base_url() . 'img/icon_7indora_app.png'; ?>" width="100" class="img-responsive center-block"/></a>
				<a href="" style="color:white;"><b>INDORA</b></a>
			</div>
				...
				<form action="login/auth" method="post">
					<div class="form-group has-feedback">
						<div class="form-group">
							<label>ID User</label>
							<input type="text" name="username" class="form-control" pattern="[A-Za-z 0-9]+" placeholder="ID User">
						</div>
						<div class="form-group">
							<label>Kata Sandi</label>
							<input type="password" name="password" class="form-control" pattern="[A-Za-z 0-9]+" placeholder="Kata Sandi">
						</div>
						<!-- <div class="form-group">
