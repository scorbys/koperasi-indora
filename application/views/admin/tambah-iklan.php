...
<div class="content-wrapper">
	...
	<section class="content">
		...
		<div class="box box-default">
			...
			<div class="box-body">
				<form action="admin/iklan/aksi_tambah" method="post" enctype="multipart/form-data">
					<div class="box-body">
						...
						<div class="form-group">
							...
							<input type="text" name="deskripsi" class="form-control" placeholder="Deskripsi Iklan"
								required>
						</div>
						<div class="form-group">
