                            ...
                            <form action="<?= base_url() ?>kasir/ppob/aksi/data" autocomplete="off" role="presentation" method="post">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input name="phone" type="text" pattern="[A-Za-z 0-9]+" placeholder="Nomor HP" id="cari_paket_data" class="form-control notelp" minlength="10" maxlength="14" onkeypress="return isNumberKey(event)" >
                                    </div><hr>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <input type="hidden" name="id_produk" pattern="[A-Za-z 0-9]+" id="id_produk" placeholder="ID Produk" class="form-control">
                                    </div>
                                    <div class="form-group">
