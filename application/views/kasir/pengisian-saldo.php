...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Pembayaran Simpanan Anggota<small> INDORA</small>
        </h1>
        <ol class="breadcrumb">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group has-error">
                                        ...
                                        <input type="text" name="no_anggota" id="no_anggota" pattern="[A-Za-z 0-9]+" class="form-control" placeholder="No. Anggota" required>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nama" class="form-control" pattern="[A-Za-z 0-9]+" placeholder="Nama Anggota" readonly disabled>
                                    </div>
                                    <div class="form-group">
                                        <label for="">Nominal (Rp)</label>
                                        <input type="text" name="nominal" class="form-control"  pattern="[A-Za-z 0-9]+" id="inputku" onkeydown="return numbersonly(this, event);" onkeyup="javascript:tandaPemisahTitik(this);" placeholder="Nominal (Hanya Angka)" required>
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    <div class="form-group">
