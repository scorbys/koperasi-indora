                  ...
                  <div class="row">
                      <div class="col-lg-12">
                          <div class="form-group">
                              ...
                              <input type="text" name="biaya" id="biaya" pattern="[A-Za-z 0-9]+" placeholder="Total Belanja" onkeyup="sum();" value="<?= $this->cart->total() ?>" class="form-control input-lg" style="background-color:white;" readonly>
                          </div>
                      </div>
                      <div class="col-lg-12">
                          <div class="form-group">
                              <label for="">Nominal Uang</label>
                              <input type="text" name="nominal" autofocus id="nominal" pattern="[A-Za-z 0-9]+" placeholder="Total Belanja" onkeyup="sum();" class="form-control input-lg" required>
                          </div>
                      </div>
                      <div class="col-lg-12">
                          <div class="form-group">
                              <label for="">Uang Kembali</label>
                              <input type="text" name="kembali" id="kembali" pattern="[A-Za-z 0-9]+" placeholder="Uang Kembali" class="form-control input-lg" required>
                          </div>
                      </div>
                  </div>
                  <div class="row">
