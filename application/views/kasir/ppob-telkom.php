                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="no_telepon" pattern="[A-Za-z 0-9]+" onkeypress="return hanyaAngka(event)" class="form-control" placeholder="Nomor Telepon" required>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <center>
                            ...
                            <a href="kasir/ppob/menu/<?= $a->kode ?>">
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-66" style="margin-bottom: 10px;">
