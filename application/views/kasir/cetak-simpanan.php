...
<body onload="window.print(); setTimeout(window.close, 0);">
    ...
    <center>
        <p>
            <strong>INDORA</strong> <br>
            <small>Jl. jendral sudirman Kav 4 Bangkle Blora<br>Email : admin@7indora.com Telp : 081809434513</small>
        </p>
        ===================================================================================
    ...
    <center>
        <p>
            <small>Terima kasih atas kepercayaan Anda kepada Indora <br> www.7indora.com</small>
        </p>
    </center>
</body>
