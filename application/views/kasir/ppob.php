                            ...
                            <form action="<?= base_url() ?>kasir/ppob/aksi/pulsa" autocomplete="off" role="presentation" method="post">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input name="phone" type="text" placeholder="Nomor HP" pattern="[A-Za-z 0-9]+" id="search_text" class="form-control notelp" minlength="10" maxlength="14" onkeypress="return isNumberKey(event)" >
                                    </div><hr>
                                    <div class="form-group">
