                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="no_telepon" pattern="[A-Za-z 0-9]+" onkeypress="return hanyaAngka(event)" class="form-control" placeholder="Nomor Pelanggan TV Kabel" required>
